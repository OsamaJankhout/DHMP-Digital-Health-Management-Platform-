...
namespace DHMPFinal.Controllers
{
    public class PharmaciesController : Controller
    {
        ...
        public PharmaciesController(DHMPProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Medicine")] Pharmacy pharmacy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Medicine")] Pharmacy pharmacy)
        {
            if (id != pharmacy.Id)
            {
                return NotFound();
